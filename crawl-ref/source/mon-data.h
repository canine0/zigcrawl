...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 880,
    3, 5, MST_IRONBOUND_THUNDERHULK, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ETTIN /*TODO*/}, TILE_ERROR
},

{
    MONS_IRONWHIP_BEASTMASTER, 'O', LIGHTGREEN, "ironwhip beastmaster",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_OGRE, MONS_OGRE, MH_NATURAL, 40,
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 550,
    2, 7, MST_IRONWHIP_BEASTMASTER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ETTIN /*TODO*/}, TILE_ERROR
},
